(function(){
    ...
    salida = ()=>{        
        ...
        if(n%2 == 0){
            document.getElementById('salida').innerHTML = "El número ingresado es par."
        }
        else if(n%3 == 0){
            document.getElementById('salida').innerHTML = "El número ingresado es multiplo de tres."
        }
        else{
            document.getElementById('salida').innerHTML = "El número no es ni par, ni multiplo de 3."
        }
    }
