(function(){
    ...
    lines_text = {
        1:{
            "text" : "Se declara la variable numero y la igualamos a lo que nos ingrese el usuario",
    ...
    // Salida
    salida = ()=>{        
        cadena = lista_datos[0] + lista_datos[1]
        document.getElementById('salida').innerHTML = "La tupla es: ('" + cadena + "',)"
    }
