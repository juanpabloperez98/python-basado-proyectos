(function(){
    ...
    // Salida
    salida = ()=>{        
        var n1 = lista_datos[0],
            n2 = lista_datos[1],
            n3 = lista_datos[2]

        if(n1<n2 && n1<n3){
            if(n2<n3){
                document.getElementById('salida').innerHTML = n1.toString() + " " + n2.toString() + " " + n3.toString()
            }else{
                document.getElementById('salida').innerHTML = n1.toString() + " " + n3.toString() + " " + n2.toString()
            }
        }
        if(n2<n1 && n2<n3){
            if(n1<n3){
                document.getElementById('salida').innerHTML = n2.toString() + " " + n1.toString() + " " + n3.toString()
            }else{
                document.getElementById('salida').innerHTML = n2.toString() + " " + n3.toString() + " " + n1.toString()   
            }
        }
        if(n3<n1 && n3<n2){
            if(n1<n2){
                document.getElementById('salida').innerHTML = n3.toString() + " " + n1.toString() + " " + n2.toString()
            }else{
                document.getElementById('salida').innerHTML = n3.toString() + " " + n2.toString() + " " + n1.toString()
            }
        }
    }
